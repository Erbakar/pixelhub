      ...
      <div className="cs-fooer_main">
        <div className="container">
          <div className="row">
            <div className="col-lg-3 col-sm-6">
              <div className="cs-footer_item">
                <div className="cs-text_widget">
                  ...
                  <p>PixelHub is a creative digital agency specializing in modern web design, development, and digital marketing solutions for businesses worldwide.</p>
                </div>
            ...
            <div className="col-lg-3 col-sm-6">
              <div className="cs-footer_item">
                <h2 className="cs-widget_title">Quick Links</h2>
                <ul className="cs-menu_widget cs-mp0">
                  <li>
                    <Link to="/">Home</Link>
                  </li>
        ...
        <div className="cs-bottom_footer">
          ...
          <div className="cs-bottom_footer_left">
            <div className="cs-copyright">Copyright © 2024 PixelHub. All rights reserved.</div>
          </div>
