...
const CTA = ({ 
  ...
  const content = (
    <div className="cs-section_heading cs-style1 text-center">
      <h3 className={`cs-section_subtitle ${subtitleColor === 'accent' ? 'cs-accent_color' : 'cs-white_color'}`}>
        {subtitle}
      </h3>
      <h2 className="cs-section_title cs-white_color">
        {title}
      </h2>
      ...
      <Link to={buttonLink} className="cs-text_btn cs-type1">
