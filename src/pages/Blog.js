          ...
          <div className="row">
            <div className="col-lg-8">
              <div className="cs-post cs-style2">
                <a href="/blog/post-1" className="cs-post_thumb">
                  <img src="/assets/img/post_1.jpeg" alt="Post" className="w-100 cs-radius_15" />
                </a>
                <div className="cs-post_info">
                  ...
                  <div className="cs-post_footer">
                    <a href="/blog/post-1" className="cs-text_btn">
              ...
              <div className="cs-post cs-style2">
                <a href="/blog/post-2" className="cs-post_thumb">
                  <img src="/assets/img/post_2.jpeg" alt="Post" className="w-100 cs-radius_15" />
                </a>
                <div className="cs-post_info">
                  <div className="cs-post_meta cs-style1 cs-ternary_color cs-semi_bold cs-primary_font">
              ...
              <div className="cs-post cs-style2">
                <a href="/blog/post-3" className="cs-post_thumb">
                  <img src="/assets/img/post_3.jpeg" alt="Post" className="w-100 cs-radius_15" />
                </a>
                <div className="cs-post_info">
                  <div className="cs-post_meta cs-style1 cs-ternary_color cs-semi_bold cs-primary_font">
                    <span className="cs-posted_by">03 Mar 2022</span>
                    <a href="/blog" className="cs-post_avatar">
